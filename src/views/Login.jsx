...
import { FlaskConical, ShieldCheck, Lock, Loader2 } from 'lucide-react';
    ...
    const handleGoogleLogin = useGoogleLogin({
        onSuccess: async (tokenResponse) => {
            ...
            try {
                ...
                alert('Connection error while fetching Google profile.');
            } finally {
    ...
    return (
        <div className="min-h-screen bg-app-bg flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="max-w-md w-full glass-panel p-8 rounded-2xl border border-white/10 shadow-glow-blue/5 text-center relative z-10 animate-in fade-in zoom-in duration-700">
                ...
                <p className="text-gray-400 mb-8 font-light italic">Secure Access for Authorized Personnel Only</p>

                <div className="bg-black/40 border border-white/5 rounded-xl p-6 mb-8 text-left transition-all hover:border-neon-blue/20">
                ...
                <div className="flex flex-col items-center gap-4 w-full">
                    <button
                        ...
                        className="group relative w-full flex items-center justify-center gap-3 px-6 py-4 rounded-xl 
                                 bg-white/5 border border-white/10 text-white font-bold transition-all duration-300
                                 hover:bg-white/[0.08] hover:border-neon-blue/40 hover:shadow-glow-blue/20
